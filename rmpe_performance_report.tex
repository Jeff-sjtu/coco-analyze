...
\resizebox{\linewidth}{!}{
\begin{tabular}{ccc}
\raisebox{15mm}{\multirow{2}{*}{\includegraphics[width=.2\linewidth]{./result/rmpe/localization_errors/keypoints_breakdown/overall_keypoint_errors.pdf}}} &
\includegraphics[width=.35\linewidth]{./result/rmpe/localization_errors/keypoints_breakdown/Miss_kpt_breakdown.pdf}  & \includegraphics[width=.35\linewidth]{./result/rmpe/localization_errors/keypoints_breakdown/Jitter_kpt_breakdown.pdf}\\
 &
\includegraphics[width=.35\linewidth]{./result/rmpe/localization_errors/keypoints_breakdown/Inversion_kpt_breakdown.pdf}  & \includegraphics[width=.35\linewidth]{./result/rmpe/localization_errors/keypoints_breakdown/Swap_kpt_breakdown.pdf} \\
\end{tabular}
}
...
\hline\hline
\includegraphics[width=.25\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/localization_errors/keypoints_breakdown/miss_0.pdf} &
\includegraphics[width=.25\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/localization_errors/keypoints_breakdown/swap_0.pdf} &
\includegraphics[width=.25\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/localization_errors/keypoints_breakdown/inversion_0.pdf} &
\includegraphics[width=.25\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/localization_errors/keypoints_breakdown/jitter_0.pdf} \\
\includegraphics[width=.25\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/localization_errors/keypoints_breakdown/miss_1.pdf} &
...
\resizebox{\linewidth}{!}{
\begin{tabular}{ccc}
\includegraphics[width=.25\linewidth]{./result/rmpe/scoring_errors/num_dts_high_oks.pdf} &
\includegraphics[width=.25\linewidth]{./result/rmpe/scoring_errors/dts_ori_score_hist.pdf} &
\includegraphics[width=.25\linewidth]{./result/rmpe/scoring_errors/dts_opt_score_hist.pdf}\\
\end{tabular}
}
...
\hline
\includegraphics[width=.2\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/scoring_errors/score_err_0_high_score.pdf} &
\includegraphics[width=.2\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/scoring_errors/score_err_0_high_oks.pdf} &
\includegraphics[width=.2\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/scoring_errors/score_err_0_high_score.pdf} &
\includegraphics[width=.2\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/scoring_errors/score_err_0_high_oks.pdf}\\
...
\hline\hline
\includegraphics[width=.25\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/background_errors/false_positives/bckd_false_pos_0.pdf} &
\includegraphics[width=.25\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/background_errors/false_positives/bckd_false_pos_1.pdf} &
\includegraphics[width=.25\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/background_errors/false_positives/bckd_false_pos_4.pdf} &
\includegraphics[width=.25\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/background_errors/false_positives/bckd_false_pos_5.pdf}\\
\includegraphics[width=.25\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/background_errors/false_positives/bckd_false_pos_2.pdf} &
...
\resizebox{\linewidth}{!}{
\begin{tabular}{cccc}
\includegraphics[width=.2\linewidth]{./result/rmpe/background_errors/false_negatives/bckd_false_neg_bbox_aspect_ratio_3.pdf} &
\includegraphics[width=.2\linewidth]{./result/rmpe/background_errors/false_negatives/bckd_false_neg_num_keypoints_histogram.pdf} &
\includegraphics[width=.2\linewidth]{./result/rmpe/background_errors/false_negatives/bckd_false_neg_bbox_area_hist.pdf} &
\includegraphics[width=.2\linewidth]{./result/rmpe/background_errors/false_negatives/bckd_false_neg_num_people_histogram.pdf}\\
\end{tabular}
}
...
\hline\hline
\includegraphics[width=.25\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/background_errors/false_negatives/bckd_false_neg_0.pdf} &
\includegraphics[width=.25\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/background_errors/false_negatives/bckd_false_neg_1.pdf} &
\includegraphics[width=.25\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/background_errors/false_negatives/bckd_false_neg_4.pdf} &
\includegraphics[width=.25\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/background_errors/false_negatives/bckd_false_neg_5.pdf}\\
\includegraphics[width=.25\linewidth,height=.15\paperwidth,keepaspectratio]{./result/rmpe/background_errors/false_negatives/bckd_false_neg_2.pdf} &
...
\resizebox{\linewidth}{!}{
\begin{tabular}{cccc}
\includegraphics[width=.22\linewidth]{./result/rmpe/benchmarks_sensitivity/occlusion_crowding/error_prc_[0-0][75][all][20].pdf} &
\includegraphics[width=.22\linewidth]{./result/rmpe/benchmarks_sensitivity/occlusion_crowding/error_prc_[0-1][75][all][20].pdf} &
\includegraphics[width=.22\linewidth]{./result/rmpe/benchmarks_sensitivity/occlusion_crowding/error_prc_[0-2][75][all][20].pdf} &
\includegraphics[width=.22\linewidth]{./result/rmpe/benchmarks_sensitivity/occlusion_crowding/error_prc_[0-3][75][all][20].pdf}\\
\includegraphics[width=.22\linewidth]{./result/rmpe/benchmarks_sensitivity/occlusion_crowding/error_prc_[1-0][75][all][20].pdf} &
\includegraphics[width=.22\linewidth]{./result/rmpe/benchmarks_sensitivity/occlusion_crowding/error_prc_[1-1][75][all][20].pdf} &
...
\resizebox{\linewidth}{!}{
\begin{tabular}{ccc}
\includegraphics[width=.3\linewidth]{./result/rmpe/benchmarks_sensitivity/occlusion_crowding/benchmark_instances.pdf} &
\includegraphics[width=.3\linewidth]{./result/rmpe/benchmarks_sensitivity/occlusion_crowding/miss_benchmark.pdf}  & \includegraphics[width=.3\linewidth]{./result/rmpe/benchmarks_sensitivity/occlusion_crowding/swap_benchmark.pdf}\\
\includegraphics[width=.3\linewidth]{./result/rmpe/benchmarks_sensitivity/occlusion_crowding/benchmark_keypoints.pdf} &
\includegraphics[width=.3\linewidth]{./result/rmpe/benchmarks_sensitivity/occlusion_crowding/inversion_benchmark.pdf}  & \includegraphics[width=.3\linewidth]{./result/rmpe/benchmarks_sensitivity/occlusion_crowding/jitter_benchmark.pdf} \\
\end{tabular}
}
...
\resizebox{\linewidth}{!}{
\begin{tabular}{cc}
\includegraphics[width=.25\linewidth]{./result/rmpe/benchmarks_sensitivity/size/ap_sensitivity.pdf} &
\includegraphics[width=.75\linewidth]{./result/rmpe/benchmarks_sensitivity/size/errors_sensitivity.pdf} \\
\end{tabular}
}
